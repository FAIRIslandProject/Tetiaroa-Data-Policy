...
b.  Description of intended outputs (which might include datasets; original software; material samples) 
...
e.  Commitment to using the Traditional Knowledge/Biocultural Notices where appropriate.
